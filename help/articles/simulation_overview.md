...
When you tap 'Run Simulation' in the toolbar menu, CircuitWorkbench:
...
4. Retrieves the result vectors and displays them on the canvas for OP analysis or on a graph viewer for TRANS, DC and AC analysis.
...
- Floating nodes (nodes with only one or no connection)
