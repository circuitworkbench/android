...
Select the component by tapping it, then tap the Delete icon (trash can) in the toolbar.
...
Select a wire segment by tapping it, then tap Delete or press. Only the selected segment is removed — other segments on the same net are unaffected. If removing the segment disconnects a component pin, that pin becomes unconnected and will appear in the Problems panel.
